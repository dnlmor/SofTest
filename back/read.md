...
Using Husky's commit-msg Hook:
Your task is to to ensure that commits follow the Conventional Commits specification (https://www.conventionalcommits.org/en/v1.0.0/)
format: <type>: <description> (NOTE: no need to apply a scope)
allowed types: 'feat', 'fix', 'test' and 'chore'


here is the content of the given link:
